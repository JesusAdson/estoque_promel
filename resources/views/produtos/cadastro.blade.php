...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-center">{{ __('Cadastro de Produtos') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="form" action="{{route('produto.store')}}" method="POST">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="date" class="form-control" name="dataFab" id="dataFab" value="{{old('dataFab', 'd-m-Y')}}">
                                    <small class="text-danger">{{$errors->has('dataFab') ? $errors->first('dataFab') : ''}}</small>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="dataVal">Data de Validade</label>
                                    <input type="date" class="form-control" name="dataVal" id="dataVal" value="{{old('dataVal', 'd-m-Y')}}">
                                    <small class="text-danger">{{$errors->has('dataVal') ? $errors->first('dataVal') : ''}}</small>
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="lote">Lote</label>
                                    <input type="number" class="form-control" name="lote" id="lote" value="{{old('lote')}}">
